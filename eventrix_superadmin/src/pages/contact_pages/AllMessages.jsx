      ...
      <div
        className={`grid gap-6 ${
          view === "list"
            ? "grid-cols-1"
            : view === "grid"
            ? "grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3" // Adjusted grid layout for wider cards
            : "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3"
        }`}
      >
        {paginatedMessages.map((message) => (
          <Link key={message._id} to={`/reply-message/${message._id}`}>
            <div className="p-6 border rounded-lg shadow-sm hover:shadow-md transition-shadow bg-white w-full max-w-[600px] mx-auto"> {/* Adjusted card width */}
